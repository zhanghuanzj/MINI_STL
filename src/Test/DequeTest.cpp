...
namespace MINI_STL{
	namespace DequeTest{
		void testCase1(){
			...
			assert(MINI_STL::Test::container_equal(dq3, dq4));

			auto dq5(dq1);
			auto dq6(dq2);
			assert(MINI_STL::Test::container_equal(dq5, dq6));

			auto dq7 = dq3;
			auto dq8 = dq4;
			assert(MINI_STL::Test::container_equal(dq7, dq8));

			auto dq9 = std::move(dq7);
			auto dq10 = std::move(dq8);
			assert(MINI_STL::Test::container_equal(dq9, dq10));
		}
		void testCase2(){
			tsDQ<int> dq1;
			assert(dq1.empty());
