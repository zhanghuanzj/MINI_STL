...
namespace MINI_STL{
	namespace ListTest{
		void testCase1(){
			...
			assert(MINI_STL::Test::container_equal(l3, l4));

			auto l5(l1);
			auto l6(l2);
			assert(MINI_STL::Test::container_equal(l5, l6));

			auto l7 = l1;
			auto l8 = l2;
			assert(MINI_STL::Test::container_equal(l7, l8));
		}
		void testCase2(){
			tsL<std::string> l1;
			assert(l1.empty());
		...
		void testCase11(){
			...
			assert(MINI_STL::Test::container_equal(first1, first2));
		}
		void testCase12(){
