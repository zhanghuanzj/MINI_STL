...
namespace MINI_STL{
	namespace VectorTest{
		...
		void testCase1(){
			stdVec<std::string> v1(10, "zh");
			tsVec<std::string> v2(10, "zh");
			assert(MINI_STL::Test::container_equal(v1, v2));

			stdVec<std::string> v3(10);
			tsVec<std::string> v4(10);
			assert(MINI_STL::Test::container_equal(v3, v4));
			...
			assert(MINI_STL::Test::container_equal(v5, v6));
		}
		void testCase2(){
			...
			auto v7 = std::move(v3);
			auto v8 = std::move(v4);
			assert(MINI_STL::Test::container_equal(v7, v8));
		}
		void testCase3(){
			tsVec<int> v1, v2;
			for (int i = 0; i != 100; ++i){
		...
		void testCase10(){
			...
			stdVec<int> foo1(3,100);
			stdVec<int> bar1(2,200);

			assert(MINI_STL::Test::container_equal(foo, foo1));
			assert(MINI_STL::Test::container_equal(bar, bar1));

			foo.swap(bar);
			assert(MINI_STL::Test::container_equal(bar, foo1));
			assert(MINI_STL::Test::container_equal(foo, bar1));
		}
		void testCase11(){
		...
		void testCase15()
		{
			...
			{
				typedef MINI_STL::vector<TestItem> TVector;
				TVector t(10);
